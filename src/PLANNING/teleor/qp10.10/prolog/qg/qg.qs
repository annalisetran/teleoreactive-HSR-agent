...
$1:
	...
	deallocate
	proceed
end('$query_qg1723003722_280/0$0'/0):



'$query_qg1723003722_280'/0:
...
$1:
	allocate(0)
	call_predicate('$query_qg1723003722_280/0$0', 0, 0)
	fail

$2:
	proceed
end('$query_qg1723003722_280'/0):
...
$1:
	execute_predicate('$query_qg1723003722_280', 0)
end('$query'/0):
