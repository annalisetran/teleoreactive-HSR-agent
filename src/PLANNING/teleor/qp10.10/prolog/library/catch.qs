...
'$query_catch1723003719_145/0$0'/0:
...
$1:
	...
	deallocate
	proceed
end('$query_catch1723003719_145/0$0'/0):



'$query_catch1723003719_145'/0:
...
$1:
	allocate(0)
	call_predicate('$query_catch1723003719_145/0$0', 0, 0)
	fail

$2:
	proceed
end('$query_catch1723003719_145'/0):
...
$1:
	execute_predicate('$query_catch1723003719_145', 0)
end('$query'/0):
