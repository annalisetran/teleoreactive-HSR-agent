...
$1:
	...
	put_y_variable(5, 1)
	put_y_variable(4, 2)
	call_predicate('$ipc_decode_peek_options', 3, 6)
	put_y_value(3, 0)
	put_x_variable(1, 1)
	put_y_value(1, 2)
	put_y_value(5, 3)
	put_y_value(4, 4)
	call_predicate('$ipc_peek', 5, 4)
	put_y_value(3, 0)
	call_predicate('ipc_peek/3$0', 1, 3)
	put_y_value(1, 0)
	put_y_value(2, 1)
	call_predicate('$same_handle_from', 2, 1)
	cut(0)
	deallocate
	proceed
end('ipc_peek'/3):
...
'$ipc_decode_peek_options/3$2/3$0'/3:
	...
	switch_on_term(0, $10, $5, $5, $6, $5, $5)

$6:
	switch_on_structure(0, 8, ['$default':$5, '$'/0:$7, 'timeout'/1:$8, 'remember_names'/1:$9])
