...
'$query_write1723003722_217/0$0'/0:
...
$1:
	...
	deallocate
	proceed
end('$query_write1723003722_217/0$0'/0):



'$query_write1723003722_217'/0:
...
$1:
	allocate(0)
	call_predicate('$query_write1723003722_217/0$0', 0, 0)
	fail

$2:
	proceed
end('$query_write1723003722_217'/0):
...
$1:
	execute_predicate('$query_write1723003722_217', 0)
end('$query'/0):
