...
'$query_handlers1723003720_334/0$0'/0:
...
$1:
	...
	deallocate
	proceed
end('$query_handlers1723003720_334/0$0'/0):



'$query_handlers1723003720_334/0$1'/0:
...
$1:
	...
	deallocate
	proceed
end('$query_handlers1723003720_334/0$1'/0):



'$query_handlers1723003720_334/0$2'/0:
...
$1:
	...
	deallocate
	proceed
end('$query_handlers1723003720_334/0$2'/0):



'$query_handlers1723003720_334/0$3'/0:
...
$1:
	...
	deallocate
	proceed
end('$query_handlers1723003720_334/0$3'/0):



'$query_handlers1723003720_334/0$4'/0:
...
$1:
	...
	deallocate
	proceed
end('$query_handlers1723003720_334/0$4'/0):



'$query_handlers1723003720_334/0$5'/0:
...
$1:
	...
	deallocate
	proceed
end('$query_handlers1723003720_334/0$5'/0):



'$query_handlers1723003720_334'/0:
...
$1:
	allocate(0)
	call_predicate('$query_handlers1723003720_334/0$0', 0, 0)
	fail

$2:
	allocate(0)
	call_predicate('$query_handlers1723003720_334/0$1', 0, 0)
	fail

$3:
	allocate(0)
	call_predicate('$query_handlers1723003720_334/0$2', 0, 0)
	fail

$4:
	allocate(0)
	call_predicate('$query_handlers1723003720_334/0$3', 0, 0)
	fail

$5:
	allocate(0)
	call_predicate('$query_handlers1723003720_334/0$4', 0, 0)
	fail

$6:
	allocate(0)
	call_predicate('$query_handlers1723003720_334/0$5', 0, 0)
	fail

$7:
	proceed
end('$query_handlers1723003720_334'/0):
...
$1:
	execute_predicate('$query_handlers1723003720_334', 0)
end('$query'/0):
