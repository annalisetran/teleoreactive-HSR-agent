...
'$query_symbols1723003721_908/0$0'/0:
...
$1:
	...
	deallocate
	proceed
end('$query_symbols1723003721_908/0$0'/0):



'$query_symbols1723003721_908'/0:
...
$1:
	allocate(0)
	call_predicate('$query_symbols1723003721_908/0$0', 0, 0)
	fail

$2:
	proceed
end('$query_symbols1723003721_908'/0):
...
$1:
	execute_predicate('$query_symbols1723003721_908', 0)
end('$query'/0):
