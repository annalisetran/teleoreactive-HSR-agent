...
'$query_string1723003721_774/0$0'/0:
...
$1:
	...
	deallocate
	proceed
end('$query_string1723003721_774/0$0'/0):



'$query_string1723003721_774'/0:
...
$1:
	allocate(0)
	call_predicate('$query_string1723003721_774/0$0', 0, 0)
	fail

$2:
	proceed
end('$query_string1723003721_774'/0):
...
$1:
	execute_predicate('$query_string1723003721_774', 0)
end('$query'/0):
