...
'$query_chr_support1723003719_241/0$0'/0:
...
$1:
	...
	deallocate
	proceed
end('$query_chr_support1723003719_241/0$0'/0):



'$query_chr_support1723003719_241'/0:
...
$1:
	allocate(0)
	call_predicate('$query_chr_support1723003719_241/0$0', 0, 0)
	fail

$2:
	proceed
end('$query_chr_support1723003719_241'/0):
...
$1:
	execute_predicate('$query_chr_support1723003719_241', 0)
end('$query'/0):
