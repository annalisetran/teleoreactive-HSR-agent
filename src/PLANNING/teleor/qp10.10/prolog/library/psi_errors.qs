...
'$query_psi_errors1723003721_314/0$0'/0:
...
$1:
	...
	deallocate
	proceed
end('$query_psi_errors1723003721_314/0$0'/0):



'$query_psi_errors1723003721_314/0$1'/0:
...
$1:
	...
	deallocate
	proceed
end('$query_psi_errors1723003721_314/0$1'/0):



'$query_psi_errors1723003721_314'/0:
...
$1:
	allocate(0)
	call_predicate('$query_psi_errors1723003721_314/0$0', 0, 0)
	fail

$2:
	allocate(0)
	call_predicate('$query_psi_errors1723003721_314/0$1', 0, 0)
	fail

$3:
	proceed
end('$query_psi_errors1723003721_314'/0):
...
$1:
	execute_predicate('$query_psi_errors1723003721_314', 0)
end('$query'/0):
