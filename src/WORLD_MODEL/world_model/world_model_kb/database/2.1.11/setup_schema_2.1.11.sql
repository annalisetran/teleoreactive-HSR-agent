...
CREATE  TABLE "public".scene ( 
	...
	scene_ts             timestamp DEFAULT CURRENT_TIMESTAMP   ,
...
CREATE OR REPLACE VIEW "public".v_cur_object AS SELECT o.object_id, o.object_class_id, oc.name, o.class_confidence, o.frame_id, o.bbox_x, o.bbox_y, o.bbox_width, o.bbox_height, o.bbox_cols, 
o.bbox_rows, o.loc_x, o.loc_y, o.loc_z, o.loc_confidence, o.colour, o.texture, o.region_id, r.label, o.size_id, sz.size_desc, o.shape_id, sh.shape_desc,
o.created, o.last_seen, o.last_updated
...
CREATE OR REPLACE VIEW "public".v_scene AS SELECT so.scene_id, s.scene_ts, so.object_id, oc.name
FROM public.scene_object so 
inner join public.scene s on so.scene_id = s.scene_id
inner join public.object o on so.object_id = o.object_id
left outer join public.object_class oc on o.object_class_id = oc.object_class_id;
...
COMMENT ON COLUMN "public".agent.agent_type IS 'E''E''P = Person\\
R = Robot''''';
...
COMMENT ON VIEW "public".v_cur_object IS 'This view contains the objects that are current in the world model, i.e. have not been deleted.';
